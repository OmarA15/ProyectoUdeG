...
<body>
    ...
    <fieldset>
        ...
        <script>
            ...
            function F5(){
                <?php
                $sql = "DELETE FROM DatosP WHERE Hora = (SELECT DISTINCT  MIN(Hora), MIN(Dia) FROM DatosP WHERE Puerta_Entrada = 2)";
                ?>
            }
        ...
        <?php
                $sql = "SELECT * FROM DatosP WHERE Puerta_Entrada = 2 ORDER BY Hora ASC, Dia ASC LIMIT 1";
